...
💼 &nbsp;Ex-SWE Intern @ **Thoughtiv** — FastAPI · NLP · Chrome MV3

🧠 &nbsp;Building with **LLMs, NLP Pipelines, RAG systems**
...
**🏢 Software Engineer Intern · Thoughtiv** &nbsp;`Jun – Oct 2025` &nbsp;·&nbsp; Hyderabad, Hybrid
- Built full-stack **SEO automation platform** — FastAPI backend + Chrome MV3 extension; cut manual effort **~60%** (25 min → <10 min)
- Designed **SpaCy NER pipeline** on CPU-only infra, replacing brittle regex across 500+ doc eval set
- Managed API versioning + staged rollouts — **99.5%+ uptime** across 3 production deployments

**🌐 Freelance Web Developer · Independent** &nbsp;`Mar – May 2025` &nbsp;·&nbsp; Remote
- Delivered 2 production apps in React + Node.js within agreed timelines
- Integrated third-party payment & booking APIs, cutting manual admin overhead for both clients
